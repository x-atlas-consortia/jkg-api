...
class JkgAPI:
    ...
    def __init__(self, config, package_base_dir):
        ...
        jkg_app = jbkgAPI('./app.cfg', package_base_dir).app
        ...
        def index():
            return "Hello! This is JKG-API service :)"
...
if __name__ == "__main__":
    try:
        jkg_app = JkgAPI('./app.cfg', Path(__file__).absolute().parent.parent.parent).app
        jkg_app.run(host='0.0.0.0', port="5002")
    except Exception as e:
